...
@Component({
  selector: 'app-emdesenvolvimento',
  standalone: true,
          ...
          <div class="stats-grid">
            <div class="stat-card">
              ...
              <div class="stat-content">
                <h3><b>Funcionalidade em desenvolvimento (Aguarde as próximas versões)</b></h3>
              </div>
            </div>
          </div>
...
export class EmDesenvolvimentoComponent implements OnInit {
